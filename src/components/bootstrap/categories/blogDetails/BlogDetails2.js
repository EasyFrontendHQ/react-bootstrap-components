...
const BlogItem = ({ item }) => {
	return (
		<div className="ezy__blogdetails2-item d-flex justify-content-between align-items-start">
...
const Contents = () => (
	<div className="ezy__blogdetails2-content mt-5">
		<p>
...
const SocialContent = () => (
	<div className="d-flex justify-content-between my-5 me-5">
		...
		<div className="ezy__blogdetails2-social">
...
const SideBar = () => (
	<Card className="ezy__blogdetails2-posts border-0">
...
const Blogdetails2 = () => {
	return (
		<section className="ezy__blogdetails2">
			<Container>
				<Row>
					<Col xs={12} md={8}>
						<h1 className="ezy__blogdetails2-heading">
