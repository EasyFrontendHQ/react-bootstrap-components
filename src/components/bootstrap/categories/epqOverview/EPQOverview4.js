...
const product = {
	...
	previews: [
		...
		{
			previewUrl: "hhttps://cdn.easyfrontend.com/pictures/products/bag2.png",
...
const ProductPreviews = ({ previews }) => {
	...
	return (
		<div className="ezy__epqoverview4-card p-3">
			<div className="text-center flex-grow-1 py-4">
				<img
					src={previews[index].previewUrl}
					alt=""
					className="ezy__epqoverview4-banner img-fluid"
				/>
			</div>

			<Nav className="ezy__epqoverview4-gallery">
...
const ColorButtons = ({ data, name, onChange, value }) => {
	...
	return (
		<Fragment>
			<h5 className="ezy__epqoverview4-title mb-2">
				Color:
				{optionDetails && (
			...
			<ButtonGroup className="ezy__epqoverview4-radios d-block mb-2">
				{data.map(({ value: rowValue, label, color, ...rowRest }, i) => (
					<ToggleButton
						key={i}
						id={`ezy__epqoverview4-${name}-${i}`}
						type="radio"
						variant=""
						name={name}
						value={rowValue}
...
const QtyField = ({ name, value, onChange }) => {
	...
	return (
		<InputGroup className="ezy__epqoverview4-qty d-inline-flex mb-2">
			<Button
				variant=""
				className="px-4"
				type="button"
...
const Epqoverview4 = () => {
	...
	return (
		<Fragment>
			<section className="ezy__epqoverview4 py-5">
				<Container>
					<Button variant="primary" onClick={handleShow}>
						Product Quick Overview 4
					</Button>
				</Container>
			</section>
			<Modal
					...
					<Row className="justify-content-center">
						...
						<Col lg={6} className="mt-4 mt-md-0">
							<div className="px-4 py-5">
								<h1 className="ezy__epqoverview4-heading mb-4 flex-grow-1">
									{product.title}
								</h1>
								<h3 className="ezy__epqoverview4-price mb-3 text-nowrap">
								...
								<Form action="src/components/bootstrap/categories/epqOverview/EPQOverview4#">
									<div className="mb-4">
										<ColorButtons
											onChange={setField}
											name="color"
									...
									<div className="mb-4">
										<h5 className="ezy__epqoverview4-title mb-2">QTY</h5>
										<QtyField
											onChange={setField}
											name="qty"
											value={formData.qty}
									...
									<Row>
										<Col className="d-flex">
											<Button
												variant=""
												className="ezy__epqoverview4-btn text-uppercase w-100 px-4 me-2 me-lg-3"
											>
												Add To Cart
											</Button>
											<Button
												variant="link"
												className="ezy__epqoverview4-btn-outline text-decoration-none w-100"
											>
												View Details
											</Button>
										</Col>
										<Col xs={12} className="mt-2">
											<Button
												variant="link"
												className="ezy__epqoverview4-fav d-inline-flex align-items-center text-decoration-none"
											>
											...
											<Button
												variant="link"
												className="ezy__epqoverview4-share d-inline-flex align-items-center text-decoration-none"
											>
												<FontAwesomeIcon
													icon={faShareAlt}
													className="fs-5 me-1"
