...
const FaqItem = ({ faq }) => {
	...
	return (
		<div className="ezy__faq3-item mt-4">
			<Button
				variant=""
				className="p-3 p-lg-4 w-100 text-start d-flex justify-content-between align-items-center ezy__faq3-btn-collapse"
				type="button"
				onClick={toggleFaq}
			>
			...
			<Collapse in={isOpen}>
				<div>
					<div className="ezy__faq3-content p-3 p-lg-4">
...
const Faq3 = () => {
	return (
		<section className="ezy__faq3">
			<Container>
				<Row className="justify-content-center mb-md-4">
					<Col lg={8} xl={7} className="text-center">
						<h2 className="ezy__faq3-heading mb-3">
							Frequently Asked Questions
						</h2>
						<p className="ezy__faq3-sub-heading mb-0">
