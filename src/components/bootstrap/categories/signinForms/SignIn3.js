...
const SocialLoginButton = () => (
	<Fragment>
		<Button
			variant="primary"
			className="ezy__signin3-btn w-100 d-flex align-items-center mb-3"
		>
		...
		<Button
			variant="danger"
			className="ezy__signin3-btn w-100 d-flex align-items-center"
		>
			<span className="text-white fs-4 lh-1">
	...
	return (
		<Form noValidate validated={validated} onSubmit={handleSubmit}>
			...
			<Button
				variant=""
				type="submit"
				className="ezy__signin3-btn-submit w-100"
			>
				Log In
			</Button>
...
const SignInFormCard = () => (
	<Card className="ezy__signin3-form-card">
...
const SignIn3 = () => {
	return (
		<section
			className="ezy__signin3 d-flex align-items-center"
			style={{
				backgroundImage:
