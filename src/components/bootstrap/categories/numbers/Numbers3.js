...
const Numbers3 = () => {
	return (
		<section className="ezy__numbers3">
			<Container>
				{/* heading  */}
				<Row className="justify-content-between">
					<Col xs={12} lg={6}>
						<div className="ezy__numbers3-contents-wrapper">
							<h1 className="ezy__numbers3-heading mb-3">
								Lorem ipsum, dolor sit amet
							</h1>
							<p className="ezy__numbers3-sub-heading mb-5">
