...
const product = {
	title: "Never Fade White Gold Color Rings",
	previews: [
		{
			previewUrl:
				"https://cdn.easyfrontend.com/pictures/ecommerce/product29.jpg",
			thumbUrl: "https://cdn.easyfrontend.com/pictures/ecommerce/product29.jpg",
		},
		{
			previewUrl:
				"https://cdn.easyfrontend.com/pictures/ecommerce/product30.jpg",
			thumbUrl: "https://cdn.easyfrontend.com/pictures/ecommerce/product30.jpg",
		},
		{
			previewUrl:
				"https://cdn.easyfrontend.com/pictures/ecommerce/product31.jpg",
			thumbUrl: "https://cdn.easyfrontend.com/pictures/ecommerce/product31.jpg",
		},
	],
	rating: 4.5,
	rateCount: 47,
		...
		<div className="me-lg-4">
			<div className="text-center rounded-3 overflow-hidden m-2">
				<img
					...
					alt=""
					className="ezy__epoverview3-banner img-fluid w-100"
				/>
			</div>
...
const ColorRadioButtons = ({ data, name, onChange, value }) => {
	...
	return (
		<Fragment>
			<h5 className="ezy__epoverview3-title mb-2">
				Color:
				{optionDetails && (
			...
			<ButtonGroup className="ezy__epoverview3-radios d-block mb-2">
				{data.map(({ value: rowValue, label, color, ...rowRest }, i) => (
					<ToggleButton
						key={i}
						id={`ezy__epoverview3-${name}-${i}`}
						type="radio"
						variant=""
						name={name}
						value={rowValue}
...
const QtyField = ({ name, value, onChange }) => {
	...
	return (
		<InputGroup className="ezy__epoverview3-qty d-inline-flex mb-2">
			<Form.Control
				type="number"
				placeholder=""
				value={value}
...
const Epoverview3 = () => {
	...
	return (
		<section className="ezy__epoverview3" id="ezy__epoverview3">
			<Container>
				<Row>
					<Col lg={6}>
					...
					<Col lg={6} className="mt-4 mt-md-0">
						<div className="mb-4 mb-lg-5">
							<h1 className="ezy__epoverview3-heading mb-3">{product.title}</h1>
							<p className="ezy__epoverview3-content fw-light mb-4">
								<span>{product.rating}</span>{" "}
								<FontAwesomeIcon icon={faStar} className="mx-2" />
								<a
									href="src/components/bootstrap/categories/epOverview/EPOverview3#!"
									className="ezy__epoverview3-review ms-1"
								>
									{product.rateCount} Reviews
								</a>{" "}
								<span className="ms-2">104 Order</span>
							</p>
							<h3 className="ezy__epoverview3-price mb-0">
								{" "}
						...
						<Form action="src/components/bootstrap/categories/epOverview/EPOverview3#">
							<div className="mb-4">
								<ColorRadioButtons
									onChange={setField}
									name="color"
							...
							<div className="mb-4">
								<h5 className="ezy__epoverview3-title mb-2">QTY</h5>
							...
							<Row className="align-items-center">
								<Col className="d-flex">
									<Button
										variant=""
										type="button"
										className="ezy__epoverview3-btn text-uppercase d-inline-flex align-items-center px-3 px-sm-5 me-1 w-100"
									>
										Buy Now
									</Button>
									<Button
										variant=""
										type="button"
										className="ezy__epoverview3-btn-outline text-uppercase bg-transparent d-inline-flex align-items-center px-3 px-sm-4 me-1 w-100"
									>
										Add To Cart
									</Button>
								</Col>
								<Col sm="auto">
									<Button
										variant="link"
										type="button"
										className="ezy__epoverview3-fav d-inline-flex align-items-center text-decoration-none"
									>
									...
									<Button
										variant="link"
										type="button"
										className="ezy__epoverview3-share d-inline-flex align-items-center text-decoration-none"
									>
							...
							<Row className="mt-4">
								<Col xs={12} lg={10} xl={8}>
									<p className="ezy__epoverview3-content mb-0">
