...
const SocialLinks = () => (
	<Nav className="ezy__copyright5-social">
...
const Copyright5 = () => {
	return (
		<section className="ezy__copyright5 text-center text-lg-start pt-5 pb-5">
			<Container>
